...
class PyDataType:
    ...
    @staticmethod
    def union(fields: dict[str, PyDataType], type_ids: builtins.list[int], mode: UnionMode) -> PyDataType: ...
    ...
    def union_fields(self) -> builtins.list[PyField]: ...
...
class PyExpr:
    ...
    def percentile(self, percentage: float) -> PyExpr: ...
...
def coalesce(items: list[PyExpr]) -> PyExpr: ...
...
def list_flatten(expr: PyExpr) -> PyExpr: ...
...
class PySeries:
    ...
    def list_flatten(self) -> PySeries: ...
    def map_get(self, key: PySeries) -> PySeries: ...
    def map_keys(self) -> PySeries: ...
...
class KeyFilteringSettings:
    ...
    @property
    def cpus_per_worker(self) -> float | None: ...
    @property
    def keys_load_batch_size(self) -> int | None: ...
    @property
...
class PyCheckpointStore:
    def list_checkpoints(self) -> list[PyCheckpoint]: ...
    def get_checkpointed_files(self) -> list[PyFileMetadata]: ...
    def mark_committed(self, ids: list[str]) -> None: ...
...
class CheckpointFileFormat(Enum):
    Iceberg = ...
    Parquet = ...
    DeltaLake = ...
...
class PyFileMetadata:
    format: CheckpointFileFormat
    data: bytes
...
class LogicalPlanBuilder:
    ...
    def with_checkpoint(self, config: CheckpointConfig) -> LogicalPlanBuilder: ...
...
class RaySwordfishTask:
    ...
    def psets(self) -> dict[int, list[RayPartitionRef]]: ...
...
class PyDaftContext:
    ...
    def notify_query_heartbeat(self, query_id: str) -> None: ...
...
class PySession:
    ...
    def get_aggregate_function(self, name: str, *args: PyExpr) -> PyExpr: ...
...
class PyDaftFile:
    ...
    @staticmethod
    def _from_file_reference(ref: PyFileReference, *, buffer_size: int | None = None) -> PyDaftFile: ...
    def __enter__(self) -> PyDaftFile: ...
    def __exit__(self, exc_type: Any, exc_val: Any, exc_tb: Any) -> None: ...
